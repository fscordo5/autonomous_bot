...
class Localization{
    private:
        ...
        ros::Subscriber subscribe_name_ , subscribe_gps_ , subscribe_imu_, subscribe_odom_;
    ...
    public:
        ...
        void handle_initial_pose(const geometry_msgs::PoseWithCovarianceStamped &pose, ros::Publisher pub2);
